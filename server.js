...
// Importar o módulo express (mova para o topo!)
const express = require('express');
// Criar uma instância do servidor JsonServer
// Essa instância é usada para criar e configurar o servidor
...
server.use(router);
// Adicionar configurações do Express diretamente ao server (que é baseado no Express)
server.use(express.static('public'));
// Definir a rota principal diretamente no server
