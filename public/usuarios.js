fetch('https://crud-node-js2.onrender.com/pessoas')
...
function atualizarDados() {
    ...
    fetch(`https://crud-node-js2.onrender.com/pessoas/${id}`, {
    ...
    fetch('https://crud-node-js2.onrender.com/pessoas')
        ...
        .then(data => {
            ...
            if (pessoa) {
                ...
                fetch(`https://crud-node-js2.onrender.com/pessoas/${pessoa.id}`, {
                    method: 'DELETE'
                })
